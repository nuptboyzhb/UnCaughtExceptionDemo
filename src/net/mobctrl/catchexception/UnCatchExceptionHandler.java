...
/**
 * @date 2014年12月18日 上午11:33:53
 * @author Zheng Haibo
 * @Description: 处理程序异常崩溃
 */
public class UnCatchExceptionHandler implements UncaughtExceptionHandler {
	...
	public UnCatchExceptionHandler(Context ctx) {
		context = ctx;
		context1 = ctx;
	}
	...
	public void uncaughtException(Thread thread, Throwable e) {
		try {
			...
			Log.e("debug", "Error while sendErrorMail" + report);
			sendErrorMail(report);
		} catch (Throwable ignore) {
			Log.e("debug", "Error while sending error e-mail", ignore);
		}
	}
